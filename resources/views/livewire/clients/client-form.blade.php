<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">{{ $isEditing ? 'Modifier le client' : 'Nouveau client' }}</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="date" wire:model="date_of_birth" id="date_of_birth" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                </div>
                                @error('date_of_birth') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>
                            
                            <div>
                                <label for="health_insurance_number" class="block text-sm font-medium text-gray-700">Numéro d'assurance santé</label>
                                <div class="mt-1">
                                    <input type="text" wire:model="health_insurance_number" id="health_insurance_number" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Numéro d'assurance santé">
                                </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <input type="text" wire:model="city" id="city" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Paris">
                                </div>
